"""
Snowflake ML Training Pipeline - Scania APS Failure Prediction

This script:
1. Connects to Snowflake using username/password authentication.
2. Loads the Snowflake TRAIN and TEST tables.
3. Uses the 20 selected features created in Snowflake.
4. Trains a Logistic Regression baseline model.
5. Evaluates the model.
6. Saves the model and evaluation results.
...
def connect_to_snowflake():
    ...
    The password is entered securely in the terminal and is
    never stored in the project files.
    """
...
def prepare_data(train_df, test_df):
    ...
    # Convert Snowflake numeric columns to numeric values
    ...
    # Remove rows where class mapping produced missing values
...
def save_results(
    ...
    with open(
        ...
        file.write(
            "SNOWFLAKE LOGISTIC REGRESSION BASELINE\n"
        )
...
def main():
    ...
    try:
        ...
        print(
            "# SNOWFLAKE ML PIPELINE COMPLETE"
        )
